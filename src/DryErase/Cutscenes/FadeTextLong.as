package DryErase.Cutscenes
{
	...
	public class FadeTextLong extends SceneEntity
	{
		...
		public function FadeTextLong(text:String,showarrow:Boolean = true,xx:Number = 320, yy:Number = 240, autoFadeIn:Boolean = true)
		{
			showArrow=showarrow;
			txt = new Text(text);
