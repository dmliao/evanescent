package DryErase.Cutscenes
{
	...
	public class FinalScene extends Entity
	{
		...
		public function FinalScene()
		{
			...
			layer = -9999;
			currentImage = new Image(Assets.finalFrame);
			x = 320;
			y = 240;
		...
		override public function update():void
		{
			if (muted == false)
			{
				if (SoundManager.currentMusic != SoundManager.musicFinal && SoundManager.currentMusic != SoundManager.musicVictory)
				{
					if (SoundManager.volumeMusic > 0)
					{
					...
					{
						SoundManager.currentMusic = SoundManager.musicFinal;
					}
				}
				else
				{
