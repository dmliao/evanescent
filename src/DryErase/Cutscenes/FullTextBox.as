package DryErase.Cutscenes
{
	...
	public class FullTextBox extends SceneEntity
	{
		private var _txt:Text;
		private var _buffer:String;
		protected var index:int;
		protected var timer:Number;
		protected const SPEED:Number = .03;
		...
		public function FullTextBox(xx:Number, yy: Number, text:String, portrait:Image, portraitRight:Boolean = false)
		{
