package DryErase.Cutscenes
{
	...
	import DryErase.Cutscenes.scenes.Ending;
	...
	public class LevelCompleteTally extends Entity
	{
		...
		public function LevelCompleteTally()
		{
		...
		public function finishTally():void
		{
			...
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.mountainCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.mountainScore < Main.currentScore)
					Main.mountainScore = Main.currentScore;
				//	newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new M_AfterLevelScene());
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "river")
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.riverCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.riverScore < Main.currentScore)
					Main.riverScore = Main.currentScore;
				//	newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new R_AfterLevelScene());
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "forest")
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.forestCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.forestScore < Main.currentScore)
					Main.forestScore = Main.currentScore;
					newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new F_AfterLevelScene());
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "flower")
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.flowerCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.flowerScore < Main.currentScore)
					Main.flowerScore = Main.currentScore;
					newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new B_AfterLevelScene());
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "castle")
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.castleCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.castleScore < Main.currentScore)
					Main.castleScore = Main.currentScore;
				//	newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new C_AfterLevelScene());
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "void")
			{
				if (Main.currentScore > Main.minimumScore)
				{
					Main.voidCompleted = 1;
					Main.levelsCompleted = Main.forestCompleted + Main.flowerCompleted + Main.mountainCompleted + Main.riverCompleted + Main.castleCompleted + Main.voidCompleted;
					if (Main.emptyScore < Main.currentScore)
						Main.emptyScore = Main.currentScore;
					//	newHighScoreFlag = true;
					FP.world = new CutsceneWorld(new Ending(),false);
					Main.saveGame();
				}
			...
			else if (Main.currentLevel == "endless")
			{
				if (Main.endlessScore <= Main.minimumScore && Main.currentScore > Main.minimumScore)
				{
				//	Main.levelsCompleted += 1;
					Main.endlessScore = Main.currentScore;
					newHighScoreFlag = true;
					FP.world = new TitleWorld();
					Main.saveGame();
				}
				else if (Main.endlessScore < Main.currentScore)
				{
					Main.endlessScore = Main.currentScore;
					newHighScoreFlag = true;
					FP.world = new TitleWorld();
