package DryErase.Cutscenes
{
	...
	public class Textbox extends SceneEntity
	{
		...
		protected const WIDTH:Number = 320;
		...
		public function Textbox(xx:Number, yy: Number, text:String, portrait:Image, portraitRight:Boolean = false)
		{
