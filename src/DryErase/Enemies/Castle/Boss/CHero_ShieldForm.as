package DryErase.Enemies.Castle.Boss
{
	...
	public class CHero_ShieldForm extends Boss
	{
		...
		public function CHero_ShieldForm()
		{
			...
			imagSprite.add("shield",[1],0,false);
			imagSprite.add("sword",[2],0,false);
			imagSprite.play("sword");
			realSprite.add("shield",[1],0,false);
			realSprite.add("sword",[2],0,false);
