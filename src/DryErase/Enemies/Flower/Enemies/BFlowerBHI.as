package DryErase.Enemies.Flower.Enemies
{
	...
	public class BFlowerBHI extends ForPauseEnemy
	{
		...
		public function BFlowerBHI()
		{
			super(new Image(Assets.B_FLOWER_IMAG), new Image(Assets.B_FLOWER_IMAG), 1, 12, 0, null, 4, 64, 64, 32, 32, 25, 120, 320, -72, false);
		}
