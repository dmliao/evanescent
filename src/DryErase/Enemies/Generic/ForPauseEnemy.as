package DryErase.Enemies.Generic 
{
	...
	public class ForPauseEnemy extends Enemy
	{
		public var moveSpeed:Number;
		public var maxSpeed:Number;
		
		private var moveAlarm:Number; //how long to move until it pauses
		public var pauseAlarm:Number; //how long to pause for
		...
		public function ForPauseEnemy(newImage:Image, shadow:Image, moveTime:Number, pauseTime:Number, shootTime:Number, shootBullet:Bullet, speed:Number = 4, hboxWidth:Number = 0, hboxHeight:Number = 0, hboxOriginX:Number = 0, hboxOriginY:Number = 0, hp:Number = 5, points:Number = 100, xx:Number = 320, yy:Number = 0, field:Boolean = false)
		{
