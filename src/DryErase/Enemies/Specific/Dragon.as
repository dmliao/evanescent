package DryErase.Enemies.Specific
{
	...
	{
		[Embed(source = '../Generic/assets/Head_Dragon.png')]
		private const HEAD:Class;
		[Embed(source = '../Generic/assets/Body_Dragon.png')]
		...
		public function Dragon(xx:Number, yy:Number, direct:Number, field:Boolean, hboxWidth:Number = 0, hboxHeight:Number = 0, hboxOriginX:Number = 0, hboxOriginY:Number = 0, size:Number = 1, lengthFactor:Number = 0.35, scaleXX:Number = 1)
		{
		...
		override public function update():void
		{
			...
			if (shootAlarm > 1)
			{
				if (shotTimes < 5)
				{
					DragonHead.shoot(new AniBullet(24,24,12,12,DragonHead.direction - 45*scaleXXX, 4, 0, false),DragonHead.x,DragonHead.y);
					DragonHead.shoot(new AniBullet(24,24,12,12,DragonHead.direction - 45*scaleXXX, 4, 0, false),DragonBody01.x,DragonBody01.y);
					DragonHead.shoot(new AniBullet(24,24,12,12,DragonHead.direction - 45*scaleXXX, 4, 0, false),DragonBody02.x,DragonBody02.y);
					DragonHead.shoot(new AniBullet(24,24,12,12,DragonHead.direction - 45*scaleXXX, 4, 0, false),DragonBody03.x,DragonBody03.y);
					DragonHead.shoot(new AniBullet(24,24,12,12,DragonHead.direction - 45*scaleXXX, 4, 0, false),DragonBody04.x,DragonBody04.y);
					shootAlarm = 0.6;
				}
			}
