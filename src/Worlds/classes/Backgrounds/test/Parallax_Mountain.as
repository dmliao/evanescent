package Worlds.classes.Backgrounds.test
{
	...
	public class Parallax_Mountain extends Entity
	{
		[Embed(source = 'MountainImag.png')]
		public const IMAGE:Class;
		[Embed(source = 'MountainImag2.png')]
		public const IMAGE2:Class;
		[Embed(source = 'MountainReal.png')]
		public const IMAGE3:Class;
		[Embed(source = 'MountainReal2.png')]
		...
		public function Parallax_Mountain(yy:Number, k:Number = 1)
		{
			if (k ==1)
			{
				img = new Image(IMAGE);
			...
			super(320 + 100 - Math.random()*200,yy, img);
			img.centerOO();
			img2.centerOO();
		}
