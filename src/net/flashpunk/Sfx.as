package net.flashpunk 
{
	...
	public class Sfx 
	{
		...
		private var leadingTime:Number;
		 ...
		 */
		public function Sfx(source:Class, leading:Number = 0, trailing:Number = 0, complete:Function = null) 
		{
		...
		public function play(vol:Number = 1, pan:Number = 0):void
		{
			...
			_channel = _sound.play(leadingTime, 0, _transform);
