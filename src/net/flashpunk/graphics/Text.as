package net.flashpunk.graphics 
{
	...
	public class Text extends Image
	{
		 ...
		 * Outline color
		 */
		public var outlineColor:uint = 0xFFFFFF;
		...
		public function updateTextBuffer():void
		{
			...
			if(outlineStrength > 0)
			{
				...
				_outlineFilter.strength = outlineStrength;
		...
		public function set text(value:String):void
		{
			...
			while (value.search("/n") != -1)
			{
				value = value.replace("/n",String.fromCharCode(10))				
			}
			while (value.search("/t") != -1)
			{
				value = value.replace("/t"," "+String.fromCharCode(9))				
			}
